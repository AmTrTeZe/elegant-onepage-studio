    ...
    <main>
      ...
      <section className="panel panel-dark" id="contexte">
        <div className="page-shell">
          ...
          <h2 className="display display-section" data-reveal><span>La croissance</span><span>impose des choix.</span></h2>
          <div className="two-cols body-copy" data-reveal>
          ...
          <p className="closing-line" data-reveal>C’est précisément là que <strong>TRADEMARK</strong> intervient.</p>
        </div>
      </section>
      ...
      <section className="panel panel-light" id="approche">
        <div className="page-shell">
          ...
          <h2 className="display display-section" data-reveal><span>Partir du besoin, pas</span><span>de la technologie</span></h2>
          <div className="two-cols body-copy approach-copy" data-reveal>
          ...
          <p className="micro-title" data-reveal>Nos critères de sélection</p>
          <div className="criteria-grid">
            {criteria.map(([number, title, copy], index) => (
              <article className="criterion" data-reveal style={{ "--delay": `${index * 55}ms` } as React.CSSProperties} key={number}>
      ...
      <section className="panel panel-light" id="reseau">
        <div className="page-shell">
          ...
          <h2 className="display display-section" data-reveal><span>Business enabler for</span><span>new markets</span></h2>
          ...
          <p className="micro-title" data-reveal>Trois leviers combinés</p>
          <div className="lever-grid">
            <article data-reveal><h3>Compréhension<br />du marché</h3><p>Transformer un marché peu ou pas adressé en opportunité de croissance.</p></article>
            <article data-reveal><h3>Relais<br />locaux</h3></article>
            <article data-reveal><h3>Accès aux<br />décideurs</h3></article>
          </div>
        </div>
      </section>
      ...
      <section className="panel panel-dark" id="intervention">
        <div className="page-shell">
          ...
          <h2 className="display display-section" data-reveal><span>Local access for</span><span>global technologies</span></h2>
          <p className="intervention-intro body-copy" data-reveal>TRADEMARK permet aux entreprises technologiques d’aborder des marchés qu’elles ne pourraient pas nécessairement adresser avec leurs seules équipes, sans engager en amont les coûts de prospection, de réseau et de présence locale qu’exigerait une approche directe.</p>
          <div className="scope-grid" data-reveal>
          ...
          <p className="closing-line" data-reveal>Notre rôle s’arrête là où commence celui de l’éditeur.</p>
        </div>
      </section>
      ...
      <section className="panel panel-light contact" id="contact">
        <div className="page-shell">
          ...
          <p className="contact-lead" data-reveal>Vous développez une technologie éprouvée, à ROI rapide, et certains marchés<br className="desktop-break" /> restent hors de vos priorités immédiates ?</p>
          <h2 className="display contact-title" data-reveal>Parlons-en.</h2>
          <div className="contact-grid">
            <aside className="offices" data-reveal>
